...
(function () {
  ...
  var DATA = {
    "ja": {
      ...
      "faq.a2": "無料版でも、動画書き出しを含む全ての基本的な制作機能をご利用いただけます。広告表示およびNIARIM公式エンドロゴの自動追加があります。具体的な料金プランは、正式リリース時にGoogle Playのアプリページでご確認いただけます。",
    ...
    "en": {
      ...
      "faq.a2": "Even the free version includes every core creation feature, including video export. It shows ads and automatically adds the official NIARIM end card. Specific pricing plans will be available on the Google Play listing at official launch.",
    ...
    "zh-Hans": {
      "faq.viewAll": "查看全部问题",
      "faq.a2": "即使是免费版，也可使用包括视频导出在内的全部基础创作功能。免费版会显示广告并自动添加 NIARIM 官方片尾标志。具体资费方案将在正式上线时于 Google Play 应用页面公布。",
    ...
    "zh-Hant": {
      "faq.viewAll": "查看全部問題",
      "faq.a2": "即使是免費版，也可使用包括影片匯出在內的全部基礎創作功能。免費版會顯示廣告並自動新增 NIARIM 官方片尾標誌。具體資費方案將於正式上線時在 Google Play 應用程式頁面公布。",
    ...
    "ko": {
      ...
      "faq.a2": "무료 버전에서도 영상 내보내기를 포함한 모든 기본 제작 기능을 이용할 수 있습니다. 무료 버전에는 광고가 표시되며 NIARIM 공식 엔드 카드가 자동으로 추가됩니다. 구체적인 요금제는 정식 출시 시 Google Play 앱 페이지에서 확인하실 수 있습니다.",
    ...
    "fr": {
      ...
      "faq.a2": "Même la version gratuite inclut toutes les fonctionnalités de création essentielles, y compris l'export vidéo. Elle affiche des publicités et ajoute automatiquement le générique de fin officiel de NIARIM. Les tarifs précis seront disponibles sur la fiche Google Play lors du lancement officiel.",
    ...
    "es": {
      ...
      "faq.a2": "Incluso la versión gratuita incluye todas las funciones de creación básicas, incluida la exportación de video. Muestra anuncios y añade automáticamente la placa de cierre oficial de NIARIM. Los planes de precios concretos estarán disponibles en la ficha de Google Play en el lanzamiento oficial.",
