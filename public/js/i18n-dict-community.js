...
(function () {
  ...
  "ja": {
    ...
    "communityPage.login.body": "アニメを描いて遊ぶことはもちろん、作品広場の閲覧・新着・ランキングの表示・作者の作品一覧の閲覧は、ログインなしでお楽しみいただけます。作品の投稿・通報・ブロックにはGoogleアカウントでのログインが必要です。投稿数は無料版で1日1作品まで、プレミアムなら1日3作品まで投稿できます。",
  ...
  "en": {
    ...
    "communityPage.login.body": "Drawing and animating, plus browsing the Gallery, new arrivals, rankings, and an author's work list, are all available without logging in. Posting, reporting, and blocking require signing in with a Google account. You can post up to 1 work a day on the free plan, or up to 3 a day with Premium.",
  ...
  "zh-Hans": {
    ...
    "communityPage.login.body": "制作动画、浏览 作品广场、查看新作与排行榜、查看作者作品列表，均无需登录即可使用。投稿作品、举报、屏蔽用户则需要使用 Google 账号登录。免费版每天最多可投稿1个作品，高级会员则最多可投稿3个。",
  ...
  "zh-Hant": {
    ...
    "communityPage.login.body": "製作動畫、瀏覽 作品廣場、查看新作與排行榜、查看作者作品列表，均無需登入即可使用。投稿作品、檢舉、封鎖使用者則需要使用 Google 帳號登入。免費版每天最多可投稿1個作品，高級會員則最多可投稿3個。",
    "communityPage.tabs.overall": "累計",
    "communityPage.tabs.yearly": "年度",
    "communityPage.tabs.monthly": "月度",
  ...
  "ko": {
    ...
    "communityPage.login.body": "애니메이션 제작은 물론, 작품광장 열람・신작・랭킹 표시・작가별 작품 목록 열람은 로그인 없이 즐기실 수 있습니다. 작품 투고・신고・차단에는 Google 계정 로그인이 필요합니다. 투고 수는 무료 버전에서 하루 1개까지, 프리미엄이라면 하루 3개까지 가능합니다.",
