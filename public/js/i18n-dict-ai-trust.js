...
(function () {
  ...
  var COPY = {
    ...
    "zh-Hans": {
      ...
      privacy: "开发者不会将用户创作或发布的内容、项目数据及其他创作数据用于生成式 AI 模型或其他机器学习模型的训练。",
    ...
    "zh-Hant": {
      ...
      privacy: "開發者不會將使用者創作或發布的內容、專案資料及其他創作資料用於生成式 AI 模型或其他機器學習模型的訓練。",
    ...
    ko: {
      ...
      privacy: "개발자는 사용자가 제작하거나 공개한 콘텐츠, 프로젝트 데이터 및 기타 제작 데이터를 생성형 AI 모델이나 다른 머신러닝 모델의 학습 데이터로 사용하지 않습니다.",
  ...
  function apply() {
    ...
    document.querySelectorAll(".updated-at").forEach(function (el) { el.textContent = text.updated; });
  }
