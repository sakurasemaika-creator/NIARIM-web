...
(function () {
  ...
  "ja": {
    ...
    "featuresPage.workspace.item2.body": "左利きの方でも操作しやすいよう、UIのレイアウトを反転できます。※ツールバーが画面下部に固定されるスマートフォンモードでは、この設定は使用できません。",
    ...
    "featuresPage.workspace.item4.body": "虹の7色やパステル調など26種類のプリセットを収録。それだけでなく、アクセントカラーから文字色・パネル背景・選択色・更新マークまで、アプリのほぼすべての色をカラーピッカーで自由に組み合わせ、自分だけのテーマに編集できます。",
  ...
  "en": {
    ...
    "featuresPage.workspace.item2.body": "Flip the UI layout so it's just as comfortable to use if you're left-handed. Note: this setting isn't available in Smartphone mode, where the toolbar is docked to the bottom of the screen.",
    ...
    "featuresPage.workspace.item4.body": "26 presets are included, from rainbow-based palettes to pastel tones. But you can go further: accent color, text color, panel background, selection color, even the update-mark color — almost every color in the app can be freely combined with a color picker to build your own theme.",
  ...
  "zh-Hans": {
    ...
    "featuresPage.workspace.item2.body": "可翻转界面布局，让惯用左手的用户也能顺手操作。※在工具栏固定于屏幕底部的手机模式下，此设置无法使用。",
    ...
    "featuresPage.workspace.item4.body": "内置彩虹七色、马卡龙色调等26种预设主题。不仅如此，主题色、文字颜色、面板背景、选中色，甚至更新标记颜色，几乎所有颜色都能用取色器自由组合，打造专属主题。",
  ...
  "zh-Hant": {
    ...
    "featuresPage.workspace.item2.title": "左手模式",
    "featuresPage.workspace.item2.body": "可翻轉介面配置，讓慣用左手的使用者也能順手操作。※在工具列固定於畫面下方的手機模式下，此設定無法使用。",
    ...
    "featuresPage.workspace.item4.body": "內建彩虹七色、粉彩色調等26種預設主題。不僅如此，主題色、文字顏色、面板背景、選取色，甚至更新標記顏色，幾乎所有顏色都能用取色器自由組合，打造專屬主題。",
    "fd.leftHandedMode": "左手模式",
  ...
  "ko": {
    ...
    "featuresPage.workspace.item2.body": "왼손잡이도 편하게 조작할 수 있도록 UI 레이아웃을 반전할 수 있습니다. ※툴바가 화면 하단에 고정되는 스마트폰 모드에서는 이 설정을 사용할 수 없습니다.",
    ...
    "featuresPage.workspace.item4.body": "무지개 7색이나 파스텔 톤 등 26종의 프리셋을 기본 제공합니다. 그뿐 아니라 포인트 컬러・글자색・패널 배경・선택색, 업데이트 표시 색까지 앱의 거의 모든 색을 컬러 피커로 자유롭게 조합해 나만의 테마로 만들 수 있습니다.",
  ...
  "fr": {
    ...
    "featuresPage.workspace.item2.body": "Inversez la disposition de l'interface pour une utilisation tout aussi confortable si vous êtes gaucher. Remarque : ce réglage n'est pas disponible en mode Smartphone, où la barre d'outils reste fixée en bas de l'écran.",
  ...
  "es": {
    ...
    "featuresPage.workspace.item2.body": "Invierte la disposición de la interfaz para que sea igual de cómoda si eres zurdo. Nota: este ajuste no está disponible en el modo Smartphone, donde la barra de herramientas queda fija en la parte inferior de la pantalla.",
