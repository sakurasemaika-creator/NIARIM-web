  ...
  var DATA = {
    ja: {
      ...
      "featuresPage.workspace.item4.body":
        "虹の7色やパステル調など26種類のプリセットを収録。それだけでなく、アクセントカラーから文字色・パネル背景・選択色・更新マークまで、アプリのほぼすべての色をカラーピッカーで自由に組み合わせ、自分だけのテーマに編集できます。",
    ...
    en: {
      ...
      "featuresPage.workspace.item4.body":
        "26 presets are included, from rainbow-based palettes to pastel tones. But you can go further: accent color, text color, panel background, selection color, even the update-mark color — almost every color in the app can be freely combined with a color picker to build your own theme.",
    ...
    "zh-Hans": {
      ...
      "featuresPage.workspace.item4.body":
        "内置彩虹七色、马卡龙色调等26种预设主题。不仅如此，主题色、文字颜色、面板背景、选中色，甚至更新标记颜色，几乎所有颜色都能用取色器自由组合，打造专属主题。",
    ...
    "zh-Hant": {
      ...
      "featuresPage.workspace.item4.body":
        "內建彩虹七色、粉彩色調等26種預設主題。不僅如此，主題色、文字顏色、面板背景、選取色，甚至更新標記顏色，幾乎所有顏色都能用取色器自由組合，打造專屬主題。",
      "fd.leftHandedMode": "左手模式",
    ...
    ko: {
      ...
      "featuresPage.workspace.item4.body":
        "무지개 7색이나 파스텔 톤 등 26종의 프리셋을 기본 제공합니다. 그뿐 아니라 포인트 컬러・글자색・패널 배경・선택색, 업데이트 표시 색까지 앱의 거의 모든 색을 컬러 피커로 자유롭게 조합해 나만의 테마로 만들 수 있습니다.",
