  ...
  var DATA = {
    ja: {
      ...
      "meta.faq.description":
        "NIARIMに関するよくある質問と回答をまとめています。",
      "faq.a5.html":
        '書き出した動画ファイルは、お使いの端末やSNSアプリを通じて自由に共有いただけます。また、NIARIMアプリ内から直接YouTubeへ投稿することで、<a href="/community/">「作品広場」</a>に作品を公開することもできます。',
      ...
      "faq.q9":
        "作品を「作品広場」に公開すると、YouTubeでも誰でも見られてしまいますか？",
      "faq.a9":
        "「作品広場」への公開は、NIARIMアプリ内からYouTubeへ動画を投稿することで行われますが、作品広場での公開・非公開はYouTube側の公開範囲とは独立した設定です。YouTube側を「限定公開」にしていても、NIARIMアプリ内の作品広場では通常どおり公開・再生でき、YouTube側の検索やおすすめには表示されにくくなります。（URLを知っている人だけが直接YouTube上でも視聴できる状態です。）逆に、YouTube側を「非公開」にしたり動画を削除したりすると、再生用URLが機能しなくなるため、NIARIM側の公開設定に関わらず作品広場での表示は自動的に停止します。（NIARIM側の公開設定自体は保持されるため、YouTube側の状態を戻せば表示も自動的に復帰します。）URLを知っている人にコメントされたくない場合は、YouTube側でコメントを無効にしておくと安心です。",
    },
    en: {
      "meta.faq.title": "FAQ | NIARIM",
      "meta.faq.description":
        "Frequently asked questions and answers about NIARIM.",
      "faq.a5.html":
        'You can freely share your exported video files through your device or other apps. You can also publish your work to the <a href="/community/">Gallery</a> by posting it to YouTube directly from within the NIARIM app.',
      ...
      "faq.q9":
        "If I publish my work to the Gallery, can anyone see it on YouTube too?",
      "faq.a9":
        "Publishing to the Gallery happens by uploading a video to YouTube from within the NIARIM app, but the Gallery's own public/private setting is independent of YouTube's visibility setting. Even if the YouTube video is set to \"Unlisted,\" it still displays and plays normally in the Gallery, while staying largely hidden from YouTube's own search and recommendations (only people with the direct link can view it there). Conversely, if the YouTube video is set to \"Private\" or deleted, its playback URL stops working, so display in the Gallery is automatically suspended regardless of your NIARIM-side setting (your NIARIM setting itself is preserved, so display resumes automatically if the YouTube status is restored). If you don't want comments from people who have the link, you can disable comments on the YouTube side for peace of mind.",
    },
    "zh-Hans": {
      "meta.faq.title": "常见问题 | NIARIM",
      "meta.faq.description": "汇总了关于 NIARIM 的常见问题与解答。",
      "faq.a5.html":
        '导出的视频文件可以自由地通过设备或其他应用进行分享。您还可以在 NIARIM 应用内直接将作品投稿至 YouTube，从而发布到 <a href="/community/">「作品广场」</a>。',
      "faq.q8": "高级会员方案能做什么？",
      "faq.a8.html":
        '可移除广告、编辑或删除片尾标志、使用自定义水印、色调曲线、色阶调整等。详情请参阅<a href="/premium/">高级会员方案页面</a>。',
      "faq.q9": "把作品发布到「作品广场」后，在 YouTube 上是不是谁都能看到？",
      "faq.a9":
        "发布到「作品广场」是通过在 NIARIM 应用内将视频上传到 YouTube 来实现的，但作品广场自身的公开/非公开设置与 YouTube 的公开范围是相互独立的。即使将 YouTube 视频设为「不公开列出」，它仍会在 NIARIM 作品广场中正常显示和播放，同时在 YouTube 自身的搜索和推荐中基本不会出现（只有知道链接的人才能在 YouTube 上直接观看）。相反，如果将 YouTube 视频设为「私享」或将其删除，播放链接将失效，因此无论 NIARIM 侧的设置如何，作品广场中的显示都会自动停止（NIARIM 侧的设置本身会被保留，一旦 YouTube 状态恢复，显示也会自动恢复）。如果不希望被知道链接的人评论，建议在 YouTube 侧关闭评论功能。",
    },
    "zh-Hant": {
      "meta.faq.title": "常見問題 | NIARIM",
      "meta.faq.description": "彙整了關於 NIARIM 的常見問題與解答。",
      "faq.a5.html":
        '匯出的影片檔案可自由地透過裝置或其他應用程式進行分享。您也可以在 NIARIM 應用程式內直接將作品投稿至 YouTube，藉此發布到 <a href="/community/">「作品廣場」</a>。',
      "faq.q8": "高級會員方案能做什麼？",
      "faq.a8.html":
        '可移除廣告、編輯或刪除片尾標誌、使用自訂浮水印、色調曲線、色階調整等。詳情請參閱<a href="/premium/">高級會員方案頁面</a>。',
      "faq.q9":
        "把作品發布到「作品廣場」後，在 YouTube 上是不是任何人都能看到？",
      "faq.a9":
        "發布到「作品廣場」是透過在 NIARIM App 內將影片上傳到 YouTube 來實現的，但作品廣場本身的公開/非公開設定與 YouTube 的公開範圍是彼此獨立的。即使將 YouTube 影片設為「不公開」，它仍會在 NIARIM 作品廣場中正常顯示與播放，同時在 YouTube 自身的搜尋與推薦中基本不會出現（只有知道連結的人才能在 YouTube 上直接觀看）。相反地，如果將 YouTube 影片設為「私人」或將其刪除，播放連結將失效，因此無論 NIARIM 端的設定為何，作品廣場中的顯示都會自動停止（NIARIM 端的設定本身會被保留，一旦 YouTube 狀態恢復，顯示也會自動恢復）。如果不希望被知道連結的人留言，建議在 YouTube 端關閉留言功能。",
    },
    ko: {
      "meta.faq.title": "자주 묻는 질문 | NIARIM",
      "meta.faq.description":
        "NIARIM에 관한 자주 묻는 질문과 답변을 정리했습니다.",
      "faq.a5.html":
      ...
      "faq.q9":
        "작품을 「NIARIM 작품 광장」에 공개하면 YouTube에서도 누구나 볼 수 있게 되나요?",
      "faq.a9":
    ...
    es: {
      ...
      "faq.a5.html":
        'Puedes compartir libremente tus archivos de video exportados a través de tu dispositivo u otras apps. También puedes publicar tu obra en la <a href="/community/">«Galería»</a> subiéndola directamente a YouTube desde la app NIARIM.',
