...
(function () {
  ...
  DICT["zh-Hans"] = {
    ...
    "contact.personalNote": "涉及账号、邮箱地址等个人信息的咨询，我们无法在 X 上处理。请通过以下表单与我们联系（表单内容将以邮件方式接收）。",
    ...
    "contact.form.attachments": "添加图片（可选）",
    "contact.form.attachmentsHint": "每张最大 5MB，最多可添加 3 张（PNG、JPEG、WebP、GIF）。",
    "contact.error.attachments": "图片数量或大小超出限制。",
  ...
  DICT["zh-Hant"] = {
    ...
    "contact.personalNote": "涉及帳號、電子郵件地址等個人資訊的諮詢，我們無法在 X 上處理。請透過以下表單與我們聯絡（表單內容將以電子郵件方式接收）。",
    ...
    "contact.form.attachments": "新增圖片（選填）",
    "contact.form.attachmentsHint": "每張最大 5MB，最多可新增 3 張（PNG、JPEG、WebP、GIF）。",
    "contact.error.attachments": "圖片數量或大小超出上限。",
  ...
  DICT.ko = {
    ...
    "contact.personalNote": "계정, 이메일 주소 등 개인정보가 포함된 문의는 X에서 답변드릴 수 없습니다. 아래 양식을 통해 문의해 주세요(양식 내용은 이메일로 접수됩니다).",
    ...
    "contact.form.attachments": "이미지 첨부(선택)",
    "contact.form.attachmentsHint": "1장당 최대 5MB, 최대 3장까지 첨부할 수 있습니다(PNG, JPEG, WebP, GIF).",
    "contact.error.attachments": "이미지 개수 또는 용량이 제한을 초과했습니다.",
  ...
  DICT.fr = {
    ...
    "contact.personalNote":
      "Nous ne pouvons pas traiter sur X les demandes impliquant des informations personnelles (compte, adresse e-mail, etc.). Merci d'utiliser le formulaire ci-dessous (les messages envoyés via ce formulaire sont reçus par e-mail).",
    ...
    "contact.form.attachments": "Joindre des images (facultatif)",
    "contact.form.attachmentsHint":
      "5 Mo maximum par image, jusqu'à 3 images (PNG, JPEG, WebP ou GIF).",
    "contact.error.attachments": "Trop d'images, ou l'une d'elles dépasse la taille limite.",
  ...
  DICT.es = {
    ...
    "contact.personalNote":
      "No podemos atender por X las consultas que impliquen datos personales (cuenta, correo electrónico, etc.). Usa el formulario a continuación (los envíos se reciben por correo electrónico).",
    ...
    "contact.form.attachments": "Adjuntar imágenes (opcional)",
    "contact.form.attachmentsHint":
      "Hasta 5 MB por imagen, un máximo de 3 imágenes (PNG, JPEG, WebP o GIF).",
    "contact.error.attachments": "Demasiadas imágenes, o una de ellas supera el límite de tamaño.",
