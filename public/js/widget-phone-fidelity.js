(function () {
  ...
  var COPY = {
    ja: {
      ...
      artwork: "起動画面",
      artworkDesc: "好きな作品のフレームを1枚表示します。タップするとNIARIMを開きます。",
      shownArtwork: "表示する作品",
      pickArtwork: "作品を選ぶ",
      create: "作品をつくる",
    ...
    en: {
      ...
      artworkDesc: "Shows one frame from a work you choose. Tap it to open NIARIM.",
    ...
    "zh-Hans": {
      title: "小组件设置", desc: "设置可放在主屏幕上的三种小组件。", note: "请长按设备主屏幕来添加小组件。", artwork: "启动画面", artworkDesc: "显示你选择的作品中的一帧，点击即可打开 NIARIM。", shownArtwork: "显示的作品", pickArtwork: "选择作品", create: "创作作品", createDesc: "直接进入新建项目的快捷方式。", plaza: "作品广场", plazaDesc: "直接进入作品广场的快捷方式。", followTheme: "跟随主题", customColor: "选择颜色",
    },
    "zh-Hant": {
      title: "小工具設定", desc: "設定可放在主畫面上的三種小工具。", note: "請長按裝置主畫面來新增小工具。", artwork: "啟動畫面", artworkDesc: "顯示你選擇作品中的一個影格，點一下即可開啟 NIARIM。", shownArtwork: "顯示的作品", pickArtwork: "選擇作品", create: "建立作品", createDesc: "直接進入新增專案的捷徑。", plaza: "作品廣場", plazaDesc: "直接進入作品廣場的捷徑。", followTheme: "跟隨主題", customColor: "選擇顏色",
    },
    ko: {
  ...
  function markup(c) {
    return '<div class="feature-diagram fd-route-screen fd-widget-settings-screen" data-mock-screen="widget-settings" aria-hidden="true">' +
      ...
      '<section class="fd-widget-section"><strong class="fd-widget-section-title">' + c.artwork + '</strong><p class="fd-widget-section-note">' + c.artworkDesc + '</p><small class="fd-widget-sublabel">' + c.shownArtwork + '</small><div class="fd-widget-artwork-tile"><span class="fd-widget-artwork-thumb">' + icon("ic-image") + '</span><strong>' + c.pickArtwork + '</strong><span class="fd-spacer"></span>' + icon("ic-chevron_right") + '</div></section>' +
      shortcutSection(c.create, c.createDesc, c, "ic-add") + shortcutSection(c.plaza, c.plazaDesc, c, "ic-public") + '</div></div>';
  }
