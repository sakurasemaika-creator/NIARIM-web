...
(function () {
  ...
  ja: {
    ...
    "featuresPage.drawing.item12.body": "指でなぞるように絵を歪ませるほか、ガウスぼかしやモザイクを直接描き込めます。長押しまたは上スワイプでサブツールを切り替えます。",
    ...
    "featuresPage.export.item6.body": "タイムラインから、現在表示中のフレーム1枚をPNGまたはJPEGで保存できます。",
  ...
  en: {
    ...
    "featuresPage.drawing.item12.body": "Warp your drawing as if tracing it with a finger, or paint Gaussian blur and mosaic effects directly. Long-press or swipe up to switch sub-tools.",
    ...
    "featuresPage.export.item6.body": "Save the frame currently displayed in the timeline as a PNG or JPEG image.",
