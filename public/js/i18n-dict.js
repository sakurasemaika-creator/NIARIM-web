...
(function () {
  ...
  var BASE = {
    ja: {
      ...
      "meta.home.title":
        "NIARIM（ニアリム）| 描く、動かす、物語にするアニメーション制作アプリ",
      ...
      "hero.note":
        "対応端末・提供状況は Google Play のページをご確認ください。",
      ...
      "featuresPage.animation.item5.title":
        "カメラワーク（キーフレームアニメーション）",
      "featuresPage.animation.item5.body":
        "XY移動・拡大・回転をキーフレームで指定すると、なめらかなカメラワークを自動で補間してくれます。レイヤー自体を描き直す必要はありません。",
      "featuresPage.animation.item6.title": "レイヤーグループ",
      "featuresPage.animation.item6.body":
        "複数のレイヤーをグループ化すれば、1つのキーフレームでまとめて動かせます。",
      ...
      "featuresPage.editing.item1.body":
        "線画・色・背景などをレイヤーで分けておけば、色だけをやり直したいときも線画に手を加えずに調整できます。",
      ...
      "featuresPage.export.item3.body":
        "制作した作品を動画ファイルとして書き出せます。",
      "featuresPage.export.item4.title": "書き出し形式",
      "featuresPage.export.item4.body":
        "MP4・WebM・GIF・AVIに対応。透過WebMなら、背景を透明にしたアニメーション素材として利用できます。",
      "featuresPage.export.item5.title": "制作・書き出し時間の上限",
      "featuresPage.export.item5.body":
        "キャンバスサイズには上限がありますが、その範囲内で作品に合わせたサイズや縦横比を設定できます。無料版では1作品あたり90秒まで、プレミアムでは1作品あたり最大2時間まで制作・書き出しできます。作品数そのものに制限はありません。",
      "featuresPage.export.item6.title": "静止画書き出し",
      "featuresPage.export.item6.body":
        "タイムラインから、現在表示中のフレーム1枚をPNGまたはJPEGで保存できます。",

      "meta.news.title": "お知らせ | NIARIM",
      "meta.news.description":
        "NIARIMの正式リリース・アップデート・メンテナンス情報をお知らせします。",
      "newsPage.eyebrow": "News",
      "newsPage.title": "お知らせ",
      "newsPage.lead":
        "正式リリース・アップデート・メンテナンス情報などを、こちらでお知らせします。",
      "newsPage.empty":
        "現在、公開中のお知らせはありません。新しい情報が入り次第、こちらに掲載します。",

      "meta.privacy.title": "プライバシーポリシー | NIARIM",
      "meta.privacy.description":
        "NIARIM公式サイトおよびアプリのプライバシーポリシーです。",
    ...
    en: {
      ...
      "meta.home.title":
        "NIARIM | An animation app for drawing, moving, and telling your story",
      "meta.home.description":
      ...
      "hero.note":
        "Please check the Google Play page for supported devices and availability.",
      ...
      "features.lead":
        "We packed in every feature we thought would be handy, without compromise.",
      ...
      "faq.a2": "Pricing details are available on the Google Play listing.",
      ...
      "faq.a7":
        "Please use the contact form on this site to send bug reports or feature requests.",
      ...
      "featuresPage.drawing.lead":
        "Multiple brushes and drawing settings for every purpose.",
      "featuresPage.drawing.item1.title": "G-pen",
      "featuresPage.drawing.item1.body":
        "A pressure-sensitive pen well suited to outlines.",
      "featuresPage.drawing.item2.title": "Pen",
      "featuresPage.drawing.item2.body":
        "A standard pen that draws even, uniform lines.",
      ...
      "featuresPage.drawing.item4.body":
        "Fine-tune the feel to match your own style.",
      "featuresPage.drawing.item5.title": "Color & transparent color",
      "featuresPage.drawing.item5.body":
        "Free color picking, plus an eraser-like transparent color.",
      ...
      "featuresPage.drawing.item8.body":
        "A standard eraser for removing parts of what you've drawn.",
      "featuresPage.drawing.item9.title": "Bucket & lasso fill",
      "featuresPage.drawing.item9.body":
        "Fill an enclosed area with the “bucket,” or a lassoed area with “lasso fill.”",
      "featuresPage.drawing.item10.title": "Eyedropper",
      "featuresPage.drawing.item10.body":
        "Pick up a color from the canvas and set it as your drawing color instantly.",
      "featuresPage.drawing.item11.title": "Selection tool",
      "featuresPage.drawing.item11.body":
        "Select an area with a rectangle or lasso, then move, transform, or delete it.",
      "featuresPage.drawing.item12.title": "Finger tool",
      "featuresPage.drawing.item12.body":
        "Warp your drawing as if tracing it with a finger, or paint Gaussian blur and mosaic effects directly. Long-press or swipe up to switch sub-tools.",
      "featuresPage.drawing.item13.title": "Shape tool",
      "featuresPage.drawing.item13.body":
        "Draw clean lines, circles, and rectangles with a single tap.",
      ...
      "featuresPage.animation.lead":
        "Stack frames and build motion on a timeline.",
      "featuresPage.animation.item1.title": "Frames",
      "featuresPage.animation.item1.body":
        "Add frames one at a time, building up your artwork.",
      "featuresPage.animation.item2.title": "Timeline",
      "featuresPage.animation.item2.body":
        "Manage more than just frames on one timeline — images, video, audio, common layers, and camera keyframes all live there too. You can also split your work into scenes to keep it organized.",
      ...
      "featuresPage.animation.item4.body":
        "Check your motion at any point while you work.",
      "featuresPage.animation.item5.title": "Camera work (keyframe animation)",
      "featuresPage.animation.item5.body":
        "Set position, zoom, and rotation as keyframes, and the app smoothly interpolates the camera movement for you — no need to redraw the layer itself.",
      "featuresPage.animation.item6.title": "Layer groups",
      "featuresPage.animation.item6.body":
        "Group multiple layers together and move them all at once with a single keyframe.",

      "featuresPage.editing.title": "Editing",
      "featuresPage.editing.lead":
        "The freedom to redo your work until it feels right.",
      "featuresPage.editing.item1.title": "Redraw freely with separate layers",
      "featuresPage.editing.item1.body":
        "Keep line art, color, and backgrounds on separate layers, so you can redo just the coloring without touching the line art.",
      ...
      "featuresPage.editing.item3.body":
        "Adjust the tolerance used for fill areas.",
      "featuresPage.editing.item4.title": "Layers",
      "featuresPage.editing.item4.body":
        "Manage elements separately with layers.",
      "featuresPage.editing.item5.title": "Common layers",
      "featuresPage.editing.item5.body":
        "Keep artwork you reuse across multiple frames — like a background — on one shared layer, and any change reflects automatically across every frame.",
      "featuresPage.editing.item6.title": "Blend modes",
      "featuresPage.editing.item6.body":
        "Change how layers combine, with modes like multiply and screen, to broaden your range of expression.",
      "featuresPage.editing.item7.title": "Clipping",
      "featuresPage.editing.item7.body":
        "Restrict a layer's drawing to the shape of the layer beneath it.",
      "featuresPage.editing.item8.title": "Free & mesh transform",
      "featuresPage.editing.item8.body":
        "Fine-tune the shape of your artwork with free transform and mesh transform. Mesh transform uses a grid of up to 10×10 to freely reshape a layer.",

      "featuresPage.audio.title": "Audio",
      "featuresPage.audio.lead":
        "Basic audio features to add sound to your work.",
      ...
      "featuresPage.audio.item3.body":
        "Specify which frame the audio starts playing from.",
      "featuresPage.audio.item4.title": "Fade in & fade out",
      "featuresPage.audio.item4.body":
        "Smooth out the start and end of your audio.",
      "featuresPage.audio.item5.title": "Timestamps",
      "featuresPage.audio.item5.body":
        "Drop a commented marker on a specific frame — handy as a reference point for lip-syncing or timing movement to sound.",
      "featuresPage.audio.item6.title": "Waveform display",
      "featuresPage.audio.item6.body":
        "Audio clips show a faint waveform overlay, letting you adjust their placement on the timeline while seeing the sound's loudness.",
      ...
      "featuresPage.export.item1.body":
        "Export at resolutions up to 1920×1920.",
      ...
      "featuresPage.export.item3.body":
        "Export your finished work as a video file.",
      "featuresPage.export.item4.title": "Export formats",
      "featuresPage.export.item4.body":
        "Supports MP4, WebM, GIF, and AVI. Transparent WebM lets you use your work as animation material with a see-through background.",
      "featuresPage.export.item5.title": "Time limit per work",
      "featuresPage.export.item5.body":
        "Canvas size has an upper limit, but within it you can set the size and aspect ratio to fit your work. The free plan supports up to 90 seconds per work; Premium supports up to 2 hours per work. There's no limit on the number of works you can make.",
      "featuresPage.export.item6.title": "Still image export",
      "featuresPage.export.item6.body":
        "Save the frame currently displayed in the timeline as a PNG or JPEG image.",

      "meta.news.title": "News | NIARIM",
      "meta.news.description":
        "Official launch, update, and maintenance announcements for NIARIM.",
      "newsPage.eyebrow": "News",
      "newsPage.title": "News",
      "newsPage.lead":
        "Official launch, update, and maintenance announcements will be posted here.",
      "newsPage.empty":
        "There are no announcements at this time. New updates will be posted here.",

      "meta.privacy.title": "Privacy Policy | NIARIM",
      "meta.privacy.description":
        "The privacy policy for the NIARIM official site and app.",
      ...
      "meta.terms.description":
        "The terms of service for the NIARIM official site and app.",
