...
assert.doesNotMatch(css, /\.features-header ~ \.feature-section\s*\{[\s\S]*?display:\s*grid\s*!important/);
assert.doesNotMatch(css, /\.features-header ~ \.feature-section > \.feature-narrative/);
