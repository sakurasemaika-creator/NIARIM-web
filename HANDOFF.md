...
**初めて触る場合は `引き継ぎガイド（AI開発者向け）.md` から読んで
ください。** 全体像・環境の整え方・守るべき禁止事項に加えて、CSSの
読み込み順と詳細度、画面再現図の仕組み、7言語の文言、フォントの
サブセット化、監査スクリプトと誤検出、見た目を撮って確かめる手順まで、
作業に必要な知識が1枚にまとまっています。

このファイルは「経緯」と「ハマりどころ」と「残タスク」に特化しています。
